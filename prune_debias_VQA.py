...
class ModelArguments:
    ...
    FTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMERT", metadata={"help": "The model fine-tuned normmally directory."}
    )
    lmhFTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMERT-LMH", metadata={"help": "The model fine-tuned with LMH  directory."}
    )
    lpfFTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMERT-LPF", metadata={"help": "The model fine-tuned with LPF  directory."}
    )
    rubiFTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMERT-RUBI", metadata={"help": "The model fine-tuned with RUBI  directory."}
    )
...
class DataTrainingArguments:
    ...
    dataroot: Optional[str] = field(
        default='/mnt/bn/qingyi-bn-lq/CompressVQA/vqacpv2/', metadata={"help": "The input text training data file (a text file)."}

    )
    img_root: Optional[str] = field(
        default='/mnt/bn/qingyi-bn-lq/CompressVQA/coco/', metadata={"help": "The input img training data file (a text file)."}
    ...
    if training_args.do_train:
        if training_args.FTmodel_type == 'noFT':
            ...
            if not model_args.FTlxmert_dir:
                ...
                print(model_args.FTlxmert_dir+'/FTlxmert_FTonly.bin')
