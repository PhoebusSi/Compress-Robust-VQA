...
# import masking.global_maskers as maskers
import masking.maskers_Robust as maskers
...
import utils4VQA
from dataset_LXM_VQAvs import Dictionary, VQAFeatureDataset
...
from hg_transformers.mask_trainer_Robust_VQA import Trainer
...
def see_weight_rate(model, model_type):
    ...
    for ii in range(5):
        ...
        para_num_dict['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.self.query.weight_mask']=float(model.state_dict()['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.self.query.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.self.key.weight_mask']=float(model.state_dict()['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.self.key.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.self.value.weight_mask']=float(model.state_dict()['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.self.value.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.output.dense.weight_mask']=float(model.state_dict()['%s.encoder.r_layers.'%model_type+str(ii)+'.attention.output.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.r_layers.'%model_type+str(ii)+'.intermediate.dense.weight_mask']=float(model.state_dict()['%s.encoder.r_layers.'%model_type+str(ii)+'.intermediate.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.r_layers.'%model_type+str(ii)+'.output.dense.weight_mask']=float(model.state_dict()['%s.encoder.r_layers.'%model_type+str(ii)+'.output.dense.weight_mask'].nelement())
    ...
    for ii in range(5):
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.att.query.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.att.query.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.att.key.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.att.key.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.att.value.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.att.value.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.output.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visual_attention.output.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.self.query.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.self.query.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.self.key.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.self.key.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.self.value.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.self.value.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.output.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_self_att.output.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.self.query.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.self.query.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.self.key.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.self.key.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.self.value.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.self.value.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.output.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_self_att.output.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_inter.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_inter.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_output.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.lang_output.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_inter.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_inter.dense.weight_mask'].nelement())
        ...
        para_num_dict['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_output.dense.weight_mask']=float(model.state_dict()['%s.encoder.x_layers.'%model_type+str(ii)+'.visn_output.dense.weight_mask'].nelement())
    ...
    para_num_dict['%s.encoder.visn_fc.visn_fc.weight_mask'%model_type]=float(model.state_dict()['%s.encoder.visn_fc.visn_fc.weight_mask'%model_type].nelement())
    ...
    para_num_dict['%s.encoder.visn_fc.box_fc.weight_mask'%model_type]=float(model.state_dict()['%s.encoder.visn_fc.box_fc.weight_mask'%model_type].nelement())
...
def init_masker(conf, model, logger, hpmodel, model_args):
    ...
    weight_types = ["E", "VV", "VB", "lK", "lQ", "lV", "lAO", "lI", "lO", "vK", "vQ", "vV", "vAO", "vI", "vO", "vlVK", "vlVQ", "vlVV", "vlVAO", "vlLaK", "vlLaQ", "vlLaV", "vlLaAO", "vlVaK", "vlVaQ", "vlVaV", "vlVaAO", "vlLi", "vlLo", "vlVi", "vlVo", "P"]
    ...
    if conf.mask_classifier:
        if conf.type != "lxmert":
            print("Cont.type should be set to lxmert !")
            assert 1==2
        names_tobe_masked.add("classifier")
        name_in_module["classifier"] = "classifier"

    
    masker.names_tobe_masked = names_tobe_masked
    if model_args.masker_level == 'modal':
        masker.name_in_module = name_in_modal
    elif model_args.masker_level == 'module':
        assert 0==1
        masker.name_in_module = name_in_module
    elif model_args.masker_level == 'layer':
        assert 0==1
        masker.name_in_module = name_in_layer 
    masker.name_of_masker = conf.name_of_masker
...
class HPmodel_modal(nn.Module):
    def __init__(self, Lang, Vis, Fus, P):
        super(HPmodel_modal, self).__init__()
        self.Lang = Lang
        self.Vis = Vis
        self.Fus = Fus
        self.P = P

        self.module_list = [self.Lang, self.Vis, self.Fus, self.P]
        self.weight_types = ['Lang', 'Vis', 'Fus', 'P'] 
        self.zerorate_dict = {}

        
        for i in range(len(self.weight_types)):
            self.zerorate_dict[self.weight_types[i]] = self.module_list[i] #zerorate_times[i]
...
class ModelArguments:
    ...
    FTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMERT4VQAvs", metadata={"help": "The model fine-tuned normmally directory."}
    )
    lmhFTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMLMH4VQAvs", metadata={"help": "The model fine-tuned with LMH  directory."}
    )
    lpfFTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMLPF4VQAvs", metadata={"help": "The model fine-tuned with LPF  directory. Do not use LPF on VQAvs due to it acc decline."}
    )
    rubiFTlxmert_dir: Optional[str] = field(
        default="xxxx/CompressVQA/pretrained_model/LXMRUBI4VQAvs-sigmoid-5e-5", metadata={"help": "The model fine-tuned with RUBI  directory.  Do not use LPF on VQAvs due to it acc decline"}
    )
...
class DataTrainingArguments:
    ...
    dataroot: Optional[str] = field(
        default='xxxx/CompressVQA/VQAvs4Compress/', metadata={"help": "The input text training data file (a text file)."}
    ...
    #cp: 2274，vqavs: 2486
    ans_num: int = field(
        default=2486, metadata={"help": "Maximum size of label space."}
    )
...
def get_dataset(args: DataTrainingArguments, tokenizer: PreTrainedTokenizer, evaluate="train"): #evaluate=False):
...
def main():
    ...
    if training_args.do_train:
        if training_args.FTmodel_type == 'noFT':
            ...
            if not model_args.FTlxmert_dir:
                print("pleaze set the model_args.FTlxmert_dir for loading the FT model(normmal) to training Masker")
                assert 0==1
            else:
                print(model_args.FTlxmert_dir+'/FTonlyNoCompress_FTonly.bin')
                model = torch.load(model_args.FTlxmert_dir+'/FTonlyNoCompress_FTonly.bin').cpu()
                if isinstance(model,torch.nn.DataParallel):
                    model = model.module

        elif training_args.FTmodel_type == 'lmh':
            if not model_args.lmhFTlxmert_dir:
                print("pleaze set the model_args.model_name_or_path for loading the model finetuned with LMH to training Masker")
                assert 0==1
            else:
                model = torch.load(model_args.lmhFTlxmert_dir+'/FTlmh_NoCompress_FTlmh_only.bin').cpu()
                if isinstance(model,torch.nn.DataParallel):
                    model = model.module


        elif training_args.FTmodel_type == 'lpf':
            if not model_args.lpfFTlxmert_dir:
            ...
            if not model_args.rubiFTlxmert_dir:
            ...
            print("training_args.FTmodel_type should be in noFT, normal, lmh, rubi, lpf ")
            assert 0==1
    ...
    if model_args.structured:
        ...
        if model_args.masker_level == "modal":
            hpmodel=HPmodel_modal(Lang=(1-model_args.Lang_comp), Vis=(1-model_args.Vis_comp),Fus=(1-model_args.Fus_comp),P=model_args.zero_rate)
        else:
            print("Currently, only sparsity allocation by modality is supported here.")
            assert 0==1

        masker = init_masker(model_args, model, logger, hpmodel, model_args)

        zero, para_num_dict, para_num, zero_num = see_weight_rate(model, model_args.model_type)
    ...
    # Get datasets
    train_dataset = get_dataset(data_args, tokenizer=tokenizer, evaluate="train") #if training_args.do_train else None

    eval_dataset = get_dataset(data_args, tokenizer=tokenizer, evaluate="val")

    test_dataset = get_dataset(data_args, tokenizer=tokenizer, evaluate="test")
    ...
    if training_args.do_eval:
        ...
        if training_args.label4save[:6] == 'normal':#load models trained in stage1
            best_model = torch.load('xxxx/CompressVQA/pretrained_model/LXMERT4VQAvs/FTonlyNoCompress_FTonly.bin').cpu()
        elif training_args.label4save[:3] == 'lmh':#load models trained in stage1
            best_model = torch.load('xxxx/CompressVQA/pretrained_model/LXMLMH4VQAvs/FTlmh_NoCompress_FTlmh_only.bin').cpu()
        elif training_args.label4save[:3] == 'lpf':#load models trained in stage1
            best_model = torch.load('xxxx/CompressVQA/pretrained_model/LXMLPF4VQAvs/FTlpf_NoCompress_FTlpf_only.bin').cpu()
        elif training_args.label4save[:4] == 'rubi':#load models trained in stage1
            best_model = torch.load('xxxx/CompressVQA/pretrained_model/LXMRUBI4VQAvs/FTrubi_NoCompress_FTrubi_only.bin').cpu()

        mask = torch.load(training_args.output_dir+"/mask.pt")
        if isinstance(mask,torch.nn.DataParallel):
            mask = mask.module

        clf_trainedMask = torch.load(training_args.output_dir+"/classifier4masker.bin").cpu()
        if isinstance(clf_trainedMask,torch.nn.DataParallel):
            clf_trainedMask = clf_trainedMask.module

        best_model.classifier = clf_trainedMask 
        pruning_model_with_mask(best_model.lxmert, mask, "lxmert") 
        trainer.model = best_model.to(training_args.device)
        ...
        with open(model_args.pred_out_dir+'/prefictions_VQAvs_test.json' , 'w') as f:
