...
export model_type=lxmert 
export label4save=lmh2lmh-VQAvs-Masker-5e-5-linearLR-20epo-$lang-$vis-$fus-zerorate$ZERO_RATE-$seed  
export training_type=Masker
export output_dir=xxx/CompressVQA/train_Robust_masker_VQAvs/$label4save/ 
mkdir -p $output_dir



python3 $ROOT_DIR/prune_debias_VQAvs.py \
