...
def _load_dataset(dataroot, name, label2ans,ratio=1.0):
    ...
    """
    if name == "train":
        question_path = 'xxxx/CompressVQA/VQAvs4Compress/Training-Ques.json' 
        question_path = 'xxxx/CompressVQA/VQAvs4Compress/Val-Ques.json' 
    elif name == 'test':
        question_path = 'xxxxCompressVQA/VQAvs4Compress/IID-Test-Ques.json' 
    else:
        assert 0==1
    ...
    # train, val
    if name == "train":
        answer_path = '/mnt/bn/qingyi-bn-lq/CompressVQA/VQAvs4Compress/cache/train_target.pkl' #'/mlx_devbox/users/sqy/playground/arnold_workspace_root/VQA/data/VQA-VS/all/cache/train_target.pkl'
    elif name == 'val':
        answer_path = '/mnt/bn/qingyi-bn-lq/CompressVQA/VQAvs4Compress/cache/val_target.pkl' #'/mlx_devbox/users/sqy/playground/arnold_workspace_root/VQA/data/VQA-VS/all/cache/val_target.pkl'
    elif name == 'test':
        answer_path = '/mnt/bn/qingyi-bn-lq/CompressVQA/VQAvs4Compress/cache/test_target.pkl' #'/mlx_devbox/users/sqy/playground/arnold_workspace_root/VQA/data/VQA-VS/all/cache/test_target.pkl'
...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, dataroot, image_dataroot, ratio, tokenizer, adaptive=False):
        ...
        ans2label_path = 'xxxx/CompressVQA/VQAvs4Compress/cache/train_val_test_ans2label.pkl' 
        label2ans_path = 'xxxx/CompressVQA/VQAvs4Compress/cache/train_val_test_label2ans.pkl' 
    ...
    def __getitem__(self, index):
        ...
        if None != answer:
            ...
            if None != scores:
                ...
                max_label = torch.tensor(int(torch.randint(0,self.num_ans_candidates,(1,)) ))
...
if __name__ == '__main__':
    ...
    loader = DataLoader(train_dset, 256, shuffle=True, num_workers=0, collate_fn=utils.trim_collate)
