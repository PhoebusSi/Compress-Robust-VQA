...
from .configuration_visualbert import visualBERT_PRETRAINED_CONFIG_ARCHIVE_MAP, visualBERTConfig
...
from .tokenization_visualbert import BasicTokenizer, BertTokenizer, BertTokenizerFast, WordpieceTokenizer
...
if is_torch_available():
    ...
    from .modeling_visualbert import (
    ...
    from .data.data_collator import DefaultDataCollator, DataCollator, DataCollatorForLanguageModeling, TrimCollator
